...
p_mod <- lm(q_mean ~ slope_fdc * runoff_ratio * baseflow_index, data = hydro)
...
##the titles for my text are not correct on this plot, bit sure why but I haven't been able to figure it out. 
```
